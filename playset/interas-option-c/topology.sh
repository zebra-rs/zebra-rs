# Inter-AS Option C (labeled loopbacks between ASBRs, PE-to-PE VPNv4) demo topology.
# Each PLAYSET_LINKS entry is "ns_a:iface_a:ns_b:iface_b".
#
#   ce1 ─┐                                             ┌─ ce3   (cust1)
#        pe1 ── p1 ── asbr1 ═══ BGP-LU loopbacks ═══ asbr2 ── p2 ── pe2
#   ce2 ─┘        AS 65501    (VPNv4 goes PE-to-PE,   AS 65502     └─ ce4   (cust2)
#                              multihop, over the top)
