...
///
/// Anomalous flags are per sub-TLV, mirroring
/// `isis::link::LinkTeMetric`: RFC 7471 gives each sub-TLV its own A
/// bit, and [`Self::merged_over`] can take neighbouring fields from
/// different sources.
