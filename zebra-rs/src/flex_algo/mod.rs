...
//! the FAD link-admission constraint engine (`link_prune_reason`), and
...
pub use config::{FlexAlgoConfig, sr_algorithms_for};
pub use constraint::{
    AffinityBits, FadConstraints, LinkAttrs, LossPercent, Pruned, link_prune_reason,
    local_link_affinity,
};
