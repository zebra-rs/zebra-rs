...
- **Next:** Phase 5 — populate the mirror-context table: static `via-vrf` path first (install the protected service SID → `End.DT46 vrftable` in `MIRROR_CONTEXT_TABLE`), then BGP-learned. Then Phase 6 (PLR repair).
