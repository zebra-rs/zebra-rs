...
- **Phase 9 hardening** — ingress **BGP-PIC** for an end-to-end node-down *service* failover; and SR-MPLS node protection (blocked on stock Linux by Risk #2 — no per-context label table; needs eBPF/VPP).
