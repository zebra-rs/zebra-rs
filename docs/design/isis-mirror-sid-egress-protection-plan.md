...
- **Next:** Phase 4 — PEB SRv6 dataplane: install End.M as `seg6local End.DT6/DT46` into a dedicated mirror-context table; plus the static-config (`via-vrf`) context-FIB population (Phase 5 MVP).
