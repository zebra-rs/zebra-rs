...
- **Next:** Phase 6 — the PLR repair (push the Mirror SID + repair list on egress/PE-CE failure, via `Nexthop::Protect` + BFD `protect_switch`). Then Phase 7 (end-to-end BDD).
