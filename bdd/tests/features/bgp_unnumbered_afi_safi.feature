...
Feature: BGP neighbor-group afi-safi inheritance on an IPv6 unnumbered iBGP session
  ...
  Scenario: Group-inherited IPv4+IPv6 capabilities negotiate and both families exchange routes
    ...
    And show command "show bgp neighbor i1" in namespace "z1" should contain "IPv4 Unicast: advertised and received"
    And show command "show bgp neighbor i1" in namespace "z1" should contain "IPv6 Unicast: advertised and received"
  ...
  Scenario: Disabling IPv4 in the group applies on clear — IPv6-only session remains
    ...
    And show command "show bgp neighbor i1" in namespace "z1" should contain "IPv6 Unicast: advertised and received"
    And show command "show bgp neighbor i1" in namespace "z1" should not contain "IPv4 Unicast:"
    And show command "show bgp neighbor i1" in namespace "z2" should not contain "IPv4 Unicast:"
