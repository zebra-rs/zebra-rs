...
use super::link::LdpLink;

pub type Callback = fn(&mut Ldp, Args, ConfigOp) -> Option<()>;
        ...
        loop {
            tokio::select! {
                ...
                Some(msg) = self.rx.recv() => {
                    ...
                    println!("LDP: RIB message received")
                }
            }
        }
    }
...
pub fn serve(mut ldp: Ldp) {
    tokio::spawn(async move {
        ldp.event_loop().await;
    });
}
