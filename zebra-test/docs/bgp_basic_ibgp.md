# BGP Basic Session Test (iBGP)

## Overview

As a network operator, I want to test basic BGP session establishment using an isolated test topology with two zebra-rs instances with iBGP connection.
